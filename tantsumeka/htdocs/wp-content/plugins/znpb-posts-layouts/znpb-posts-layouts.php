...
/**
 * Plugin Name: ZNPB Blog-Posts Layouts Element
 * Plugin URI: http://hogash.com
 * Description: This plugin will generate various layouts of blog posts for Kallyas Page builder.
 * Version: 1.1.3
...
class ZnPbBlogPostsLayoutsElement{
	...
	function __construct(){
		...
		load_plugin_textdomain('znpb-posts-layouts', false, basename( dirname( __FILE__ ) ) . '/languages' );
	}
...
ZnPbBlogPostsLayoutsElement::get_instance();