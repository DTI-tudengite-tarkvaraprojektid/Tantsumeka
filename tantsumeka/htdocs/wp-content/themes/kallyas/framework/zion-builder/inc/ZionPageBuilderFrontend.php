...
class ZionPageBuilderFrontend
{
	...
	function prepareContent()
	{
		...
		if ( ZNB()->utility->isPageBuilderEnabled() && ! post_password_required() ) {
	...
	function setupSingleElement( $element_data )
	{
		...
		if ( $element_data[ 'object' ] === 'ZnPbCustomTempalte' || $element_data[ 'object' ] === 'ZnSmartArea') {
	...
	function getElementInstance( $elementData )
	{
		...
		if( $element_type_instance === false ){
			return false;
		}
