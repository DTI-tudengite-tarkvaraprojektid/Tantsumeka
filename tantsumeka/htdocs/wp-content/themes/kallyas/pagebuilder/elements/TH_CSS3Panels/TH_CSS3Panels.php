	...
	function options()
	{
		...
		$options = array (
			...
			'help' => znpb_get_helptab( array(
				'video'   => sprintf( '%s', esc_url('https://my.hogash.com/video_category/kallyas-wordpress-theme/#t702hKJbbns') ),
				'docs'    => sprintf( '%s', esc_url('https://my.hogash.com/documentation/css3-panels/') ),
				'copy'    => $uid,
				'general' => true,
			)),
