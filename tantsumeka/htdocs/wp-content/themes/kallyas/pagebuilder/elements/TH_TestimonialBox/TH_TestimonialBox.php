...
@media screen and (max-width: 767px) {
	.tb-'.$uid.'[data-align=left] .tst-box-bqt:after {
	...
	function options()
	{
		...
		$options = array(
			...
			'help' => znpb_get_helptab( array(
				'video'   => sprintf( '%s', esc_url('https://my.hogash.com/video_category/kallyas-wordpress-theme/#LmhkFB2frSM') ),
				'docs'    => sprintf( '%s', esc_url('https://my.hogash.com/documentation/testimonial-box/') ),
				'copy'    => $uid,
				'general' => true,
			)),
