		...
		$options = array(
			...
			'general' => array(
				...
				'options' => array(
					...
					array (
						"name"        => __( "Show Image Tooltip", 'zn_framework' ),
						"description" => __( "Show image tooltips on hover?", 'zn_framework' ),
						"id"          => "img_tooltip",
						"std"         => "",
						'type'        => 'zn_radio',
						'options'        => array(
					...
					array (
						"name"        => __( "Tooltip Image Sizes", 'zn_framework' ),
						"description" => __( "Choose the tooltip image sizes.", 'zn_framework' ),
							...
							<?php
								if(isset($entry['pl_img']) && !empty($entry['pl_img'])){
									...
									if( $this->opt('img_tooltip', 'yes') == 'yes' ){
										...
										// Tooltip
										$_tooltip_sizes =  $this->opt('img_sizes_tooltip', array('width'=>'275', 'height'=>'275') ); ;
